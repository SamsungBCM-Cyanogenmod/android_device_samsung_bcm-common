...
/**
 * Backwards compatible RIL implementation for Broadcom MSIM based
 * radios. Android 4.3 added the CELL_INFO_LIST commands, displacing several
 * command ids already used in pre-4.3 RILs.
 * 
 * {@hide}
 */
public class BroadcomMSIMRIL extends RIL implements CommandsInterface {
    ...
    public BroadcomMSIMRIL(Context context, int networkMode,
